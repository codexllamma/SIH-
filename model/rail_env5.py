...
class RailEnv(gym.Env):
    ...
    def _compute_reward(self, comps: Dict[str, float]):
        ...
        w_illegal_switch = float(rc.get("w_illegal_switch", 0.1))  # new penalty
        ...
        # Debug logging for reward issues
        #print(f"Step {self.current_step}: Raw comps: {comps}, Total reward: {total}")
